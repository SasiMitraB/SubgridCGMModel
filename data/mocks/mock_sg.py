...
resolution = (16, 8)
file_path = f"/ptmp/mpa/dipda/subgrid/SubgridCGMModel/AthenaK_legacy/sd_build/src/spcc{resolution[0]}_{resolution[1]}/bin"
save_path = f"mocks/sg/spcc{resolution}/"
