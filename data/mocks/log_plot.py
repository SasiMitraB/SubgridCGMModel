# Python script to plot the actual and predicted PDFs using an analytic form for the PDFs (3 lognormals)
...
sys.path.append(os.path.join(os.path.dirname(__file__), '../..'))
from models.conv_nn.log_cnn import snapshot_pred
...
mp4_path = "mocks/pdf/log_pdf_animation.mp4"
...
mp4_path_compare = "mocks/pdf/log_pdf_compare_animation.mp4"
