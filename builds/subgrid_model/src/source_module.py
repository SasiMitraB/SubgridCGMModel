...
model_save_dir = os.environ.get("MODEL_SAVES_DIR", f"/Volumes/PortableSSD/Projects/SubgridCGMModel/outputs/model_saves/pdf_model_saves")

input_mean = np.load(
    os.path.join(model_save_dir, "cnn_(512, 256)_32_input_mean.npy")
)

input_std = np.load(
    os.path.join(model_save_dir, "cnn_(512, 256)_32_input_std.npy")
)
...
def source_func(rho, pres, ux, uy, ps, fmcl):
    ...
    model_path = os.path.join(
        model_save_dir, "cnn_(512, 256)_32.pth"
    )
